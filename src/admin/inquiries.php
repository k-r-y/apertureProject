...
<body class="admin-dashboard">
    ...
    <a href="#" id="replyBtn" class="btn btn-gold">
    ...
    <script>
        ...
        // ... (Your existing functions: loadInquiries, loadActivityLog, etc.)
...
function refreshCurrentTab() {
    ...
    if (activeTab.id === 'messages-tab') {
        loadInquiries();
        // Visual feedback
        const btn = document.querySelector('button[onclick="refreshCurrentTab()"] i');
        btn.classList.add('spin-animation'); // Assuming you have a CSS spin class
