...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2025 at 04:36 PM
...
CREATE TABLE `users` (
  ...
  `tokenExpires_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
INSERT INTO `users` (`userID`, `Email`, `Password`, `Role`, `FirstName`, `LastName`, `FullName`, `contactNo`, `isVerified`, `profileCompleted`, `verificationToken`, `tokenExpires_at`, `created_at`, `updated_at`, `passwordResetCode`, `resetCodeExpires_at`) VALUES
(1, 'pawcasiano@kld.edu.ph', '$2y$10$CE4XFND.B0KzoXDlkrD.NulRLiJ/Sad9bV25exeha6DxN05cfef1S', 'Admin', 'Prince Andrew', 'Casiano', 'Prince Andrew Casiano', '09001219271', 1, 1, NULL, NULL, '2025-11-11 05:53:05', '2025-11-11 05:54:08', NULL, NULL),
(1000, 'casianoprince5@gmail.com', '$2y$10$41StmVfaFbL/xSpw3kDHE.KIJuG1iVX3tv18blADjAE19WQB4J5bW', 'User', 'test', 'user', 'test user', '09977676554', 1, 1, NULL, NULL, '2025-11-11 05:59:07', '2025-11-11 05:59:43', NULL, NULL);
...
ALTER TABLE `users`
  ...
  ADD KEY `idx_verification` (`verificationToken`),
